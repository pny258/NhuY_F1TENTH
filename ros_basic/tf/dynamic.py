...
class SimpleTfKinematics(Node):
    ...
    def __init__(self):
        ...
        self.static_transform_stamped_.header.frame_id = "base_link3"
        ...
        self.static_transform_imu.header.frame_id = "base_link3"
        self.static_transform_imu.child_frame_id = "imu3"
        ...
        self.static_transform_laser.header.frame_id = "base_link3"
        self.static_transform_laser.child_frame_id = "laser3"
    ...
    def timerCallback(self,msg:Odometry):
        ...
        self.dynamic_transform_stamped_.header.frame_id = "odom3"
        self.dynamic_transform_stamped_.child_frame_id = "base_link3"
